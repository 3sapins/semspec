 ...
 */
router.get('/horaire/eleve/:eleveId', adminMiddleware, async (req, res) => {
    try {
 ...
 */
router.get('/horaires/eleves', adminMiddleware, async (req, res) => {
    try {
 ...
 */
router.get('/horaires/enseignants', adminMiddleware, async (req, res) => {
    try {
 ...
 */
router.get('/absences', adminMiddleware, async (req, res) => {
    try {
